...
st.set_page_config(page_title="AI 자기소개서 & 면접 답변 개선 도구", layout="wide", initial_sidebar_state="expanded")
st.markdown("""
    <style>
    body {
...
def interview_feedback():
    st.header("✅ 면접 답변 피드백")
    st.markdown("입력한 면접 답변을 AI가 분석하여 **더 나은 답변**을 추천합니다.\n\n특정 면접 질문에 대한 모범 답변과 예상 질문도 함께 제공합니다.")
...
def audio_feedback():
    ...
    st.markdown("사용자의 음성 녹음을 분석하여 **발음**, **억양**, **속도** 등을 평가합니다.\n\n현재는 파일 업로드 후 간단한 피드백을 제공하는 기능을 준비 중입니다.")
...
def resume_template():
    ...
    st.markdown("직무별 최적화된 **이력서 및 자기소개서 템플릿**을 제공합니다.\n\n원하는 직무를 선택하여 예시 템플릿과 추천 문장을 확인해보세요.")
...
def score_system():
    st.header("✅ 점수 시스템 도입")
    st.markdown("AI가 자기소개서 및 면접 답변의 완성도를 평가하여 **점수화** 합니다.\n\n강점과 개선점을 시각적으로 확인할 수 있습니다.")
